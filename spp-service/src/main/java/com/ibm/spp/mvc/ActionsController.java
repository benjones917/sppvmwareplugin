...
import com.ibm.spp.services.SampleActionService;
...
public class ActionsController {
   ...
   // Empty controller to avoid warnings in spp's bundle-context.xml
   ...
   public Map<String, Object> invoke(
      ...
      if (actionUid.equals("com.ibm.spp.sampleAction1")) {
      ...
      } else if (actionUid.equals("com.ibm.spp.sampleAction2")) {
